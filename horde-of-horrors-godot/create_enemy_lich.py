template = """[gd_scene load_steps=5 format=3 uid="uid://enemy_lich"]
...
[ext_resource type="Texture2D" uid="uid://lich_tex" path="res://assets/sprites/enemies/lich/lich.png" id="3"]
...
with open("scenes/EnemyLich.tscn", "w") as f:
    f.write(template)

print("Created EnemyLich.tscn")
